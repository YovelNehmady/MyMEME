...
function getKeyNewSize(elKey) {
    const style = window.getComputedStyle(elKey, null).getPropertyValue('font-size')
    const pxIdx = style.lastIndexOf('p')
    const dig = +style.substring(0, pxIdx)
    return dig + 2
}
